...
// It creates:
// An array of size 7
// Each slot is Option<i32>
// Initially all are None

// this can be like this structure [None, None, None, None, None, None, None]
...
// maps weekday to index
// bridge between named enum and arrayed index
